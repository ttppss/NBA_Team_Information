...
<body>
	<%
		...
		Gson gson = new Gson();
		String json = test.findTeamById("583ecd4f-fb46-11e1-82cb-f4ce4684ea4c");
	...
	<!-- out.println("
	<br>" + "Team ID: " + spur.getId()); out.println("
	<br>" + "Team Name: " + spur.getName()); out.println("
	<br>" + "Team Alias: " + spur.getAlias()); out.println("
	<br>" + "Time Founded: " + spur.getFounded()); out.println("
	<br>" + "Market: " + spur.getMarket()); out.println("
	<br>" + "Venue ID: " + spur.getVenue().getId()); out.println("
	<br>" + "Venue Name: " + spur.getVenue().getName()); out.println("
	<br>" + "Venue Capacity: " + spur.getVenue().getCapacity());
	out.println("
	<br>" + "Venue Address: " + spur.getVenue().getAddress());
	out.println("
	<br>" + "Venue City: " + spur.getVenue().getCity()); out.println("
	<br>" + "Venue State: " + spur.getVenue().getState());
	out.println("
	<br>" + "Venue Zip: " + spur.getVenue().getZip()); out.println("
	<br>" + "Venue Country: " + spur.getVenue().getCountry());
	out.println("
	<br>" + "League ID: " + spur.getLeague().getId()); out.println("
	<br>" + "League Alias: " + spur.getLeague().getAlias());
	out.println("
	<br>" + "League Name: " + spur.getLeague().getName());
	out.println("
	<br>" + "Conference ID: " + spur.getConference().getId());
	out.println("
	<br>" + "Conference Name:" + spur.getConference().getName());
	out.println("
	<br>" + "Conference Alias" + spur.getConference().getAlias());
	out.println("
	<br>" + "Division ID: " + spur.getDivision().getId());
	out.println("
	<br>" + "Division Name: " + spur.getDivision().getName());
	out.println("
	<br>" + "Division Alias: " + spur.getDivision().getAlias()); %> -->
</body>
</html>